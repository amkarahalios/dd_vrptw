...
if set_to_try == 3:
  ...
  "Vrp-Set-HG-C12-124_primal_param_files/lns/CE_MIP_LNS_2" : "CE+MIP+LNS",
  }

if set_to_try == 4:
  instance_type = 3
  parameter_set_names_strings = {
    "X_primal_param_files/best/CE_Random_2/" : "CE",
    "PyVRP" : "PyVRP",
    "VRPSolver" : "VRPSolver"
  }
...
if set_to_try == 5:
  instance_type = 1
  parameter_set_names_strings = {
    "Vrp-Set-HG_primal_param_files/best/CE_Random_2/" : "CE",
    "PyVRP" : "PyVRP",
    "VRPSolver" : "VRPSolver"
  }
...
times_for_metrics = range(0,3700,100)
...
if "RopkePisinger" in parameter_set_names_strings:
  pyvrp_results_df = read_logs.get_ropke_pisinger_results(instances)
  ce_results_df = pandas.concat([ce_results_df, pyvrp_results_df])
